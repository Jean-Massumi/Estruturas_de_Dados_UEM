...
class Fila:
    ...
    def enfileira(self, item: str):
        ...
        *CAPACIDADE*.
        ...
        self.fim = self.indice_auxiliar(self.fim)
    ...
    def desenfileira(self) -> str:
        ...
        self.inicio = self.indice_auxiliar(self.inicio)
    ...
    def indice_auxiliar(self, indice_atual) -> int:
        '''
        Calcula qual é proximo indice a partir de um indice qualquer.
        '''

        if indice_atual == CAPACIDADE:
            prox_ind = 0
        else:
            prox_ind = indice_atual + 1
